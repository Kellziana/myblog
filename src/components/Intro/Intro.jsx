  ...
  return (
    <div>
        ...
        <section class = "info">
                ...
                <p> My name is Samina Arshad and I am a 3rd year UCC student
                    ...
                    I see myself in that particular area in future.</p>
        </section>
        <section class = "cs">
            <section class ="why"> 
                <h2>Why UI design?</h2>
                <p>I enjoy coding and thinking logically as well as creatively.
            ...
            <section class="what">
                <h2>What else?</h2>
                <p> I also enjoy working on the back-end of a development. I have an
                    interest in working on databases and working with data. I have worked on projects 
                    consisting of databases using SQL. </p>
            </section>
        </section>
    </div>
  )
